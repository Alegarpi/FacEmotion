...
async function modelLoaded() {
  let counter = 0;
  let classifier = await model.classification(3);
  ...
  async function go() {
    ...
    for(let i = 1; i <= 300; i++) {
        img_url.push("./archive_masked/anger/img (" + i + ").png");
        img_url.push("./archive_masked/happiness/img (" + i + ").png");
        img_url.push("./archive_masked/sadness/img (" + i + ").png");
    }
